...
public class Main {
    ...
    public static void main(String[] args) {
            ...
            if (((MaWlasnosciRownolegloboku) ((MoznaWyznaczycWielokrotnoscPrzekatnej) (Prostokat) kwadrat1x1))
                    .podstawa() > 0)
            ...
            // przeciążanie metod
            if (((MoznaWyznaczycWielokrotnoscPrzekatnej) prostokat1x2).wielokrotnoscPrzekatnej(1.) == Math.sqrt((1 * 1) + (2 * 2)))
